...
//                           <div className="putto">
//                           <h4>This web based risk calculator estimates the risk of cytokine storm activaton in Covid-19 patients, which is
//                             based on epidemiological, vital signs and laboratory findings.
//                             Ref:
//                             1. Eva W. Cheung at al. Multisystem Inflammatory Syndrome Related to COVID-19 in Previously Healthy Children and Adolescents in New York City. JAMA. June 08, 2020. doi:10.1001/jama.2020.10374</h4>
//                         </div>
//                         </div>

//                         <div className="Analytics">
//                           <div className="col">
//                             <div className="aos-refresh-onload aos-init aos-animate" data-aos="fade-up">
//                               <div id="page-desc-mortality" className="elevation-3 jumbotron" style={{padding: '4%'}}>
...
//                                     a medical institution and are willing to contribute to our effort, please reach out to us <a href="https://www.covidanalytics.io/contact">here</a>.</p>
//                                 </div>
//                               </div>
//                             </div>
//                           </div>
...
//                           var checked=false;
//                       <Checkbox label={{children:'do u have readings'}} checked={checked} onChange={() => setChecked(!checked)}/>  
//                         if(checked==true)
//                         {
...
//                                 <input placeholder ="DDIMER" color="red" type="number" id="dd" onchange="checkDD()" required />
...
//                               <div id="mortality-model-desc" className="elevation-3 jumbotron" style={{padding: '4%'}}>
...
//                                   deceased) is <span style={{color: 'rgb(128, 0, 32)', fontWeight: 'bold'}}> 0.82</span>.<br />When
...
//                         </div>
//                         <div className="graph">
//                           <img src="https://www.covidanalytics.io/assets/risk_calculators/mortality/model_without_lab.jpg" width="60%" height="20%" className="center" dispaly="center" />
//                         </div>
//                         <div className="information">
//                           <pre>Moderate and high risk patients require aggressive monitoring of inflammatory milieu or up triaging. Anti-inflammatory therapy with steroid and Anticoagulation recommended.{"\n"}*Please note these are mere recommendation from the author based on the available scientific recommendation and no means intended to replace local guidelines.{"\n"}{"\n"}* compulsary{"\n"}{"            "}</pre>
//                         </div>
...
//                               <div className="respa">Epidemiology:
//                                 <span id="span1" />
//                               </div>
//                               <div className="respa">Vital Signs:
//                                 <span id="span2" />
//                               </div>
//                               <div className="respa">Lab-Findings:
//                                 <span id="span3" />
//                               </div>
//                             </div>
